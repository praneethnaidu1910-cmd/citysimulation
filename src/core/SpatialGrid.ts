...
export class SpatialGridImpl implements SpatialGrid {
  ...
  private entityToCells: Map<string, string[]> = new Map();
  ...
  getEntitiesInRadius(center: GridPosition, radius: number): Entity[] {
    ...
    const entitiesInRadius = new Set<Entity>();
  ...
  getEntitiesInArea(area: GridPosition): Entity[] {
    ...
    const entitiesInArea = new Set<Entity>();
  ...
  private getEntityCells(position: GridPosition): string[] {
